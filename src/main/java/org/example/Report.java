...
public class Report {
    ...
    public static final String HABIT_ADD = "Введите название, описание и продолжительность привычки. Название привычки должно быть уникальным. Как разделительный символ используйте ';'."; // Сообщение, если пользователь хочет добавить привычку
    ...
    public static final String HABIT_SHOW_START = "Ваши привычки:"; // Сообщение, если пользователь хочет посмотреть привычки
    ...
    public static final String HABIT_EDIT_FAIL2 = "Привычку нельзя так  отредактировать!"; // Сообщение, если привычка не отредактирована
